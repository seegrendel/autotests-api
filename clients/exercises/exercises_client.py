...
from clients.exercises.exercises_schema import UpdateExercisesRequestSchema, UpdateExerciseResponseSchema, \
    CreateExerciseResponseSchema, CreateExercisesRequestSchema, GetExerciseResponseSchema, GetExercisesResponseSchema, \
